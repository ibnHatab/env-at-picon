...
(defvar esense-minor-mode-map
  (let ((map (make-sparse-keymap)))
     (define-key map (kbd "C-1") 'esense-do-something-at-point)
     (define-key map (kbd "M-1") 'esense-go-to-documentation)
     (define-key map (kbd "M-2") 'esense-go-to-function-documentation)
...
(defvar esense-minor-mode-completion-map
   (let ((map (make-sparse-keymap)))
     ...
     (define-key map (kbd "C-2") 'esense-completion-insert-item)
